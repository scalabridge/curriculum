...
![](/setup/img/address_bar.png?raw=true "address bar")
...
![](/setup/img/command_prompt.png?raw=true "command prompt in home directory")
...
![](setup/img/scala_bridge_directory.png?raw=true "scala bridge directory")
